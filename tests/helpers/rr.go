...
const (
	...
	// appear. Delivery from beanstalkd normally lands well inside a second.
...
// listener binds after the driver has dialed beanstalkd, so dialing it proves the
